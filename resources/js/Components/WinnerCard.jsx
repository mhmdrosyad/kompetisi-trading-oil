...
export default function WinnerCard({ user, index }) {
    ...
    return (
        <div
            key={index}
            className="mb-3 bg-white relative block overflow-hidden rounded-lg border border-gray-100 p-4 sm:p-6 lg:p-8"
        >
            ...
            <div className="flex gap-3 justify-between sm:gap-4">
                ...
                <div className="bg-yellow-300 rounded-full h-6 w-6 flex items-center justify-center p-5">
                    {user.custom_rank}
                </div>
            </div>

            <dl className="mt-6 flex flex-col sm:flex-row sm:justify-between gap-4 sm:gap-6">
                ...
                <div>
                    <PrimaryButton
                        onClick={() => {
                            const phoneNumber = user.profile.whatsapp_number; // Nomor telepon dari data
