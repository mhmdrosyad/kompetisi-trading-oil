...
export const GuestFooter = () => {
    ...
    return (
        <footer className="border-t mt-12 text-gray-500 bg-white px-4 py-5 mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <ApplicationLogo className="w-32 mb-3 sm:mx-auto" />
                <p className="leading-relaxed mt-2 text-[15px]">
                    Trading adalah aktivitas perdagangan yang memiliki peluang
                    dan/atau resiko yang tinggi, pastikan anda memahami dan siap
                    dengan segala resiko sebelum memulainya.
                </p>
            </div>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2025 Akademi Trading Oil. All rights reserved.
                </div>
